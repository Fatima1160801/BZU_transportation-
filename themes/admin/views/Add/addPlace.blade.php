        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{url("/admin/insertpickupPlaces")}}" method="post" >
                    @csrf
                    <input type="hidden" id="cabTypee" name="cabTypee" value="bus" class="form-control">
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <form action="{{url("/admin/insertdropoffPlaces")}}" method="post" >
                        ...
                        <input type="hidden" id="cabType" name="cabType" value="bus" class="form-control">
