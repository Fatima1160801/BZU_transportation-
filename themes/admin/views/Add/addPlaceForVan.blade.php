        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{url("/admin/insertpickupPlaces")}}" method="post" >
                    @csrf
                    <input type="hidden" id="cabTypee" name="cabTypee" value="van" class="form-control">
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <form action="{{url("/admin/insertdropoffPlaces")}}" method="post" >
                        ...
                        <input type="hidden" id="cabType" name="cabType" value="van" class="form-control">
