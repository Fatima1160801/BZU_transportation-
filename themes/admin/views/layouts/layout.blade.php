            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa ti-truck"></i><a href="{{url('/admin/AddBusTrips')}}"> {{__('web.Bus')}} </a></li>
                        <li><i class="fa fa-truck"></i><a href="{{url('/admin/AddVanTrips')}}">{{__('web.Van')}}</a></li>
                        <li><i class="fa ti-car"></i><a href="{{url('/admin/AddTaxiTrips')}}"> {{__('web.Taxi')}} </a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-map-marker"></i><a href="{{url('/admin/TrackDrivers')}}">{{__('web.Track Drivers')}} </a></li>
                        <li><i class="fa fa-plus"></i><a href="{{url('/admin/AddDriver')}}"> {{__('web.Add New driver')}} </a></li>
                        <li><i class="fa fa-info"></i><a href="{{url('/admin/informationDriver')}}">{{__('web.Information')}} </a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-pencil-square"></i><a href="{{url('/admin/ManualBookings')}}"> {{__('web.Manual Bookings')}} </a></li>
                        <li><i class="fa ti-gift"></i><a href="{{url('/admin/ManageRewards')}}">{{__('web.Manage Rewards')}} </a></li>
                        <li><i class="fa fa-info"></i><a href="{{url("/admin/informationPassenger")}}">{{__('web.Information')}} </a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-plus"></i><a href="{{url("/admin/AddAdmin")}}">{{__('web.Add New Admin')}} </a></li>
                        <li><i class="fa fa-info"></i><a href="{{url("/admin/informationAdmin")}}">{{__('web.Information')}} </a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="{{url('/admin/NNotifications')}}"><i class="menu-icon fa fa-bell-o"></i> {{__('web.Send Notifications')}} </a>
                </li>
                <li>
                    <a href="{{url('/admin/Messages')}}"> <i class="menu-icon ti-email"></i> {{__('web.Send Messages')}} </a>
                </li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa ti-money"></i><a href="{{url('/admin/ManageRewards')}}">{{__('web.Track Earnings')}}</a></li>
                        <li><i class="menu-icon fa ti-time"></i><a href="{{url('/admin/RushHours')}}">{{__('web.Rush Hours')}}</a></li>
                ...
                <div class="col-sm-5">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="{{url('/admin/Profile')}}"><i class="fa fa-user"></i>{{__('web.My profile')}} </a>
