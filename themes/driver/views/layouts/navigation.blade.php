        ...
        <div class="flex justify-between h-16 text-gray-500 hover:text-gray-700 text-sm font-medium leading-5">
            <div class="flex">
                ...
                <div class="flex items-center flex-shrink-0">
                    <a href="{{url('driver/home')}}">
                        <img alt="fatima"  style="height: 55px;padding-left:40px ;width:150px" src="{{asset('driver/images/bzu.png')}}">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    ...
                    <form id="logout-form" action="{{ route('driver.logout') }}" method="POST" class="hidden">
                        @csrf
                    </form>
                @endauth
            </div>
