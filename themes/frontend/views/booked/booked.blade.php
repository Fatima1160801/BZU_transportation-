                    ...
                    <div class="card-body">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                $dr=$trip->driver->name;
                                $cabNum=$trip->driver->cabs->cabNumber;
                                    } ?>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <label class="control-label" for="BookingsList_0__NumberOfPassengers"><i class="fa fa-users"></i>  {{__('web.Seat Number')}} </label>
                                    <p>{{$idpass->seatNum}}</p>
                                ...
                                <div id="map-0" class="collapse clps">
                                    ...
                                    -->
                                    <form method="POST" action="{{url("delete/$idpass->id")}}">
                                        @csrf
                                        <input type="hidden" value="{{$idpass->id}}" name="id">
                                        <input type="hidden" name="statusTrip" value="deleted">
                                        <input type="hidden" name="seatNum" value="{{$idpass->seatNum}}">
                                        <input type="hidden" name="trip_id" value="{{$idpass->trip_id}}">
                                        <input type="hidden" name="passengerCounter" value="{{$trip->passengerCounter}}">
                                        ...
                                        <button  class="btn btn-danger btn-block" >{{__('web.Cancel Booking')}}</button>
                                            ...
                                            @elseif ($idpass->statusTrip == "confirmed" )
                                            ...
                                            @elseif ($idpass->statusTrip == "deleted")
                                            ...
                                            @elseif ($idpass->statusTrip == "completed")
