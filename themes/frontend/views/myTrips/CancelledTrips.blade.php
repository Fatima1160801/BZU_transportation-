        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                                ...
                                <div  class=" p-md-2   ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-pills nav-justified mb-3 mt-2" id="pills-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link "  href="{{url("/passenger/My-Trips/$passid")}}" role="tab"  aria-selected="false">{{__('web.All trips')}} </a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                             <a class="nav-link active"   href="{{url("/passenger/My-Trips/CancelledTrips/$passid")}}" role="tab"  aria-controls="pills-home" aria-selected="true"> {{__('web.Cancelled trips')}} </a>
               ...
               <!-- <taxtarea>$passengerTrip->passenger_id</taxtarea> -->
                ...
                @if ($passTrip->trip_id == $myTrips->id && $myTrips->statusTrip=='deleted')
