            ...
            <div class="col-lg-12">
                                ...
                                <div  class=" p-md-2   ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-pills nav-justified mb-3 mt-2" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link"  href="{{url("/passenger/My-Trips/UpcomingTrips/$passid")}}" role="tab" aria-selected="true" > {{__('web.Upcoming trips')}} </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active"  href="{{url("/passenger/My-Trips/CompletedTrips/$passid")}}" role="tab"  aria-selected="false">{{__('web.Completed trips')}} </a>
                                            </li>
                                            <li class="nav-item">
               ...
               <!-- <taxtarea>$passengerTrip->passenger_id</taxtarea> -->
                   ...
                   @foreach ($passengerTrips as $passTrip)
                    ...
                    @if ($passTrip->trip_id == $myTrips->id && $myTrips->statusTrip=='completed')
