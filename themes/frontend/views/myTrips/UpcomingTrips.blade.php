            ...
            <div class="col-lg-12">
                                ...
                                <div  class=" p-md-2   ">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-pills nav-justified mb-3 mt-2" id="pills-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link "  href="{{url("/passenger/My-Trips/$passid")}}" role="tab" aria-controls="pills-home" aria-selected="false">{{__('web.All trips')}} </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active"  href="{{url("/passenger/My-Trips/UpcomingTrips/$passid")}}" role="tab" aria-selected="true" > {{__('web.Upcoming trips')}} </a>
                                            </li>
                                            <li class="nav-item">
               ...
               <!-- <taxtarea>$passengerTrip->passenger_id</taxtarea> -->
                   ...
                   @foreach ($passengerTrips as $passTrip)
                    ...
                    @if ($passTrip->trip_id == $myTrips->id && ($myTrips->statusTrip=='waiting' ||  $myTrips->statusTrip=='confirmed' ) )
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="map-0" class="collapse clps">
                                            <div id="mapcanvas-76476"
                                                ...
                                                <form method="POST" action="{{url("delete/$passTrip->id")}}">
                                                    @csrf
                                                    <input type="hidden" value="{{$passTrip->id}}" name="id">
                                                    <input type="hidden" name="statusTrip" value="deleted">
                                                    <input type="hidden" name="seatNum" value="{{$passTrip->seatNum}}">
                                                    <input type="hidden" name="trip_id" value="{{$passTrip->trip_id}}">
                                                    <input type="hidden" name="passengerCounter" value="{{$myTrips->passengerCounter}}">
                                                    ...
                                                    <div class="card-footer">
                                                        <div class="panel-footer">
                                                            @if($myTrips->statusTrip=='waiting')
                                                            <div id="BookingProgress-117650887" class="row bookingprogress">
                                                                <div class="col-sm-2 stage w-50 bg-success">
                                                            ...
                                                            @elseif ($myTrips->statusTrip=='confirmed')
                                                            <div id="BookingProgress-117650887" class="row bookingprogress">
                                                                <div class="col-sm-2 stage ">
                                                                    <span>{{__('web.Waiting')}} </span>
                                                                </div>
